package org.processmining.streamabstractrepresentation.utils;
...
public class GUIUtils {
	...
	public static JLabel prepareTitle(String s) {
		JLabel labelTitle = new JLabel(s);
		labelTitle.setFont(labelTitle.getFont().deriveFont(Font.BOLD, 14f));
		labelTitle.setForeground(UIColors.darkGray);
